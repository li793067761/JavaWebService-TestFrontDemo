...
<head>
	...
	<%-- <script type="text/javascript" src="${ctxStatic}/js/flat-ui/flat-ui.min.js"></script> --%>
...
<body class="fillHeight">
		<div style="height:10%;width:100%;"><tiles:insertAttribute name="head" /> </div>
		<%-- <div style="height:100%;width:20%;float:left;"><tiles:insertAttribute name="menu" /> </div> --%>
		<div style="height:90%;width:100%;"><tiles:insertAttribute name="content" /> </div>
</body>
